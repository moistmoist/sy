...
//中間フラグ
grap[20][x1] = DerivationGraph( 0, 182, 40, 60, mgrap[x1]) ;
...
oto[100]=LoadSoundMem( "BGM/titerman.mp3" ) ;
//oto[101]=LoadSoundMem("BGM/stage1.mp3");
//oto[102]=LoadSoundMem("BGM/stage2.mp3");
oto[103]=LoadSoundMem( "BGM/spelunk.mp3" ) ;
oto[104]=LoadSoundMem( "BGM/star4.mp3");
oto[105]=LoadSoundMem( "BGM/makaimura.mp3");
